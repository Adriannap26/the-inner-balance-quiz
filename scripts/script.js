/*document.addEventListener('DOMContentLoaded', () => { */
    ...
    function showQuestion(index) {
        ...
        questions[index].answers.forEach(answer => {
            ...
            button.addEventListener('click', () => handleAnswer(index, answer, button));
    ...
    function handleAnswer(index, selectedAnswer, clickedButton) {
        ...
        //disable all buttons after selecting answer
